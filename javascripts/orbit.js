...
(function() {
  var HALF_PI, Orbit, TWO_PI, acosh, angleInPlane, brentsMethod, circularToEscapeDeltaV, cosh, crossProduct, ejectionAngle, goldenSectionSearch, insertionToCircularDeltaV, insertionToCircularDeltaV2, newtonsMethod, normalize, projectToPlane, sign, sinh;
  ...
  insertionToCircularDeltaV2 = function(body, vsoi, v0, rdest, d) {
    var a, b, dx, dy, e, mu, r0, rsoi, th, v;
    mu = body.gravitationalParameter;
    rsoi = body.sphereOfInfluence;
  ...
  Orbit.transfer = function(transferType, originBody, destinationBody, t0, dt, initialOrbitalVelocity, finalOrbitalVelocity, p0, v0, n0, p1, v1, planeChangeAngleToIntercept, distancia) {
